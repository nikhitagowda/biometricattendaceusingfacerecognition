...
def DispWin():
    ...
    message = tk.Label(window, text="Attendance Management System", fg="white", bg="black",
    ...
    takeImg = tk.Button(window, text="Take Images", command=TakeImages, width=15, height=2, activebackground="Red",
                        font=('times', 17, ' bold '))
    takeImg.place(x=200, y=500)
    trainImg = tk.Button(window, text="Train Images", command=TrainImages, width=15, height=2, activebackground="Red",
                         font=('times', 17, ' bold '))
    trainImg.place(x=500, y=500)
    quitWindow = tk.Button(window, text="Quit", command=window.destroy, width=12, height=2, activebackground="Red",
                           font=('times', 17, ' bold '))
...
Attend = tk.Button(window1, text="Attendance", command=TrackImages, width=10, height=2, activebackground="Red",
                   font=('times', 15, ' bold '))
Attend.place(x=110, y=140)
Register = tk.Button(window1, text="Register", command=DispWin, width=10, height=2, activebackground="Red",
                     font=('times', 15, ' bold '))
Register.place(x=360, y=140)
message2 = tk.Label(window1, text="", bg="grey", activeforeground="black", width=30, height=2,
                    font=('arial', 15, ' bold '))
